<div align="center">
  ...
  <h1 id="intro-oss">🍕 Intro to Open Source with OpenSauced 🍕</h1>
...
- [Glossary](../intro-oss/10-glossary.md): A glossary of common terms and definitions used in open source.
- [Additional Resources](../intro-oss/08-additional-resources.md): A list of resources for further learning about open source, including blog posts, tutorials, and guides.

## Getting Started

To start the course, navigate to the [`intro` file](../intro-oss/01-intro.md) in the repository or visit the [Intro to Open Source with OpenSauced website](https://intro.opensauced.pizza/) and start reading! Each chapter builds on the previous one, so we recommend reading them in order.
...
To learn more about using OpenSauced to build your open source resume, check out the [Building Your Open Source Resume](../intro-oss/06-the-secret-sauce.md#building-your-open-source-resume) section in [The Secret Sauce](../intro-oss/06-the-secret-sauce.md) chapter.
